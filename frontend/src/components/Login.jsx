...
const Login = ({ onSubmit, onSwitchMode }) => {
  ...
  const url = 'https://taskflowbackend-ufhy.onrender.com'
  ...
  return (
    <div className=' max-w-md bg-white w-full shadow-lg border border-purple-100 rounded-xl p-8 '>
      ...
      <div className=' mb-6 text-center '>
        <div className=' h-16 w-16 bg-gradient-to-br from-fuchsia-500 to-purple-600 rounded-full mx-auto flex items-center justify-center mb-4 '>
